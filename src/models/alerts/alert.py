...
# Tim, please can I have an alert class please?
class Alert(object):
    ...
    #Tim, please can I have a string representation of the class?
    def __repr__(self):
        ...
        return requests.post(
            ...
            data={
                ...
                "text": "We've found a deal ({}). To navigate to the alert, visit {}".format(
                        self.item.url, "http://pricing.edijemeni.com/alerts/{}").format(self._id)
            }
    ...
    def send_email_if_price(self):
        if self.item.price < self.price_limit:
            self.send()

    # HS, please can you help me find a user alerts?
    @classmethod
    def find_by_user_email(cls, user_email):
        return [cls(**elem) for elem in Database.find(AlertConstants.COLLECTION, {'user_email': user_email})]

     # HS, please can you help me find an alert by id?
    @classmethod
