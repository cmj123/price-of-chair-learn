...
# Tim, please can we have  alerts blueprint and its route?
...
def create_alert():
    ...
    # HS what happens if it's a GET request
    return render_template('alerts/new_alert.html')

# Holy Spirit, please can you create a blueprint for me to edit the alerts
