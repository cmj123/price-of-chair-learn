...
# Tim, please can I have a store object?
class Store(object):
    ...
    # please can I have a URL representation of the store object
    def __repr__(self):
    ...
    def find_by_url(cls,url):
        for i in range(0, len(url)+1):
            try:
                ...
                raise StoreErrors.StoreNotFoundException("The URL prefix used to find the store didnt give any results!")

    # HS, please retrieve all the available stores for me?
    @classmethod
    def all(cls):
        return [cls(**elem) for elem in Database.find(StoreConstants.COLLECTION, {})]

    # Holy Spirit please help me delete a store?
    def delete(self):
